...
public class MailSender {
     ...
     */
    public int initializeConnection(final String userName, final String mailAddress, final String domain, final String password) {
        return initializeConnection(HOST, PORT, userName, mailAddress, domain, password);
    }
     ...
     * @param password Account password
     */
    public int initializeConnection(String host, String port, final String userName,
        ...
        //huom huom tää ei sit lainkaan testaa onko salasana oikein, jos ei ole niin lähettämisvaiheessa tulee ongelmia
        return 0;
    }
